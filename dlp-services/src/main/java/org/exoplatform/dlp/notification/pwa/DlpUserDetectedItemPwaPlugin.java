...
public class DlpUserDetectedItemPwaPlugin implements PwaNotificationPlugin {

  public static final String     ID = "DlpUserDetectedItemPlugin";
  private static final String   TITLE_LABEL_KEY = "pwa.notification.DlpUserDetectedItemPlugin.title";

  private ResourceBundleService resourceBundleService;

  public DlpUserDetectedItemPwaPlugin(ResourceBundleService resourceBundleService) {
