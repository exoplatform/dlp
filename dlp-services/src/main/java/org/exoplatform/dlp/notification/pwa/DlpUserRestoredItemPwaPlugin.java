...
public class DlpUserRestoredItemPwaPlugin implements PwaNotificationPlugin {

  public static final String ID = "DlpUserRestoredItemPlugin";
  private static final String   TITLE_LABEL_KEY = "pwa.notification.DlpUserRestoredItemPlugin.title";

  private ResourceBundleService resourceBundleService;

  public DlpUserRestoredItemPwaPlugin(ResourceBundleService resourceBundleService) {
